...
def test_available_moves3():
    ...
    targets.append(Move(True, 2, (0,1), (0,1)))
    targets.append(Move(True, 3, (0,1), (0,1)))
    targets.append(Move(True, 4, (0,1), (0,1)))
    targets.append(Move(True, 5, (0,1), (0,1)))
    targets.append(Move(True, 6, (0,1), (0,1)))
    targets.append(Move(True, 7, (0,1), (0,1)))
    targets.append(Move(True, 8, (0,1), (0,1)))

    targets.append(Move(True, 2, (1,1), (0,1)))
    targets.append(Move(True, 4, (1,1), (0,1)))
    targets.append(Move(True, 6, (1,1), (0,1)))
    targets.append(Move(True, 8, (1,1), (0,1)))

    targets.append(Move(True, 2, (2,0), (0,1)))
    targets.append(Move(True, 4, (2,0), (0,1)))
    targets.append(Move(True, 6, (2,0), (0,1)))
    targets.append(Move(True, 8, (2,0), (0,1)))
